...
This CocoaPod provides the ability to use a UILabel that may be started and stopped blinking.
  ...
  s.homepage         = 'https://github.com/nahuelDeveloper/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'nahuelDeveloper' => 'nahuel.developer@gmail.com' }
  s.source           = { :git => 'https://github.com/nahuelDeveloper/BlinkingLabel.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/NR_RULO'
